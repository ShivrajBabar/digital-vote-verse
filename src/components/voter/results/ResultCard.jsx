    ...
    <Card>
      <CardHeader className="bg-gray-50 border-b">
        <div className="flex justify-between items-center">
          <div>
            <CardTitle>{result.election_name}</CardTitle>
          ...
          <div className="flex items-center mt-1">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                {winner.party} • {winner.votes} votes ({Math.round((winner.votes / result.total_votes) * 100)}%)
              </p>
            </div>
          </div>
        </div>
          ...
          <>
                ...
                <tbody>
                  {result.candidates?.sort((a, b) => b.votes - a.votes).map((candidate, index) => (
                    <tr key={index} className={index === 0 ? "bg-green-50" : "border-b"}>
                      ...
                      <td className="px-4 py-3 text-right">{candidate.votes}</td>
                  ...
                  <tr className="bg-gray-50 font-medium">
                    ...
                    <td className="px-4 py-2 text-right">{result.total_votes}</td>
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="p-3 bg-gray-50 rounded-md">
                ...
                <p>Type: {result.election_type}</p>
                <p>Total Constituencies: {result.total_constituencies}</p>
              ...
              <div className="p-3 bg-gray-50 rounded-md">
                ...
                <p>Voter Turnout: {result.voter_turnout}%</p>
